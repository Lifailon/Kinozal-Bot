...
⚠️ Бот предназначен исключтельно для локального использования, так как основной целью является централизованное управление приложениями в **вашей домашней среде** находясь удаленно от дома (краткий обзор в **[публикации на Habr](https://habr.com/ru/articles/782028/)**), по этому предварительно вам необходимо [настроить](#%EF%B8%8F-настройка) подключение бота к вашим приложениям.
...
На базе бота реализовн новостной канала 📢 [Kinozal-News](https://t.me/kinozal_news), который генерирует посты на основе новых публикаций в торрент трекере **[Кинозал](https://kinozal.tv)** с фильтрацией по **рейтингу (7.0+)** и **году выхода (2023+)**. Каждый пост содержит краткую информацию о раздаче (год выхода, страна и компания производства, рейтинг, качество и перевод), а также **# хештеги по жанру для фильтрации контента на канале** и кнопки с ссылками описания фильма или сериала в базах данных о кинематографе [Кинопоиск](https://www.kinopoisk.ru) и [IMDb](https://www.imdb.com), бесплатный онлайн просмотр через плееры ▶️ [Kinobox](https://kinobox.tv) и 🧲 [магнитные ссылки](https://en.wikipedia.org/wiki/Magnet_URI_scheme) для загрузки содержимого раздачи в торрент клиенте (применимо как для bittorrent-клиентов на телефоне, так и Linux или Windows).
