...
- Клиентское приложение **VPN** и/или **Proxy-сервер** для доступа в Кинозал (*опционально*) и TMDB.
...
- 2.3. Возможен вариант использования обратного прокси сервер, у которого есть прямой доступ к трекеру, например, через [ReverseProxyNET](https://github.com/Lifailon/ReverseProxyNET):
...
> ⚠️ **ReverseProxyNET (rpnet)** не поддерживает авторизацию на трекере, который использует домены 3-го уровня для обработки некоторых запросов.
