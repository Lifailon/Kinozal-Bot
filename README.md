...
> Скорость получения информации из трекера Кинозал на прямую зависит от скорости работы вашего интернет и/или VPN соединения.
...
- 🍿 Получение информации о выбранном сериале в Кинозал (стандартный вывод для всех раздач), из данного интерфейса происходит управление торрент файлом) и управление загрузкой в клиенте 🔳 Transmission:

<h1 align="center">
<img src="image/examples/kinozal-info.jpg" width="400"/></a> <img src="image/examples/transmission.jpg" width="400"></a>
</h1>

- 👥 Поиск по актеру в трекере Кинозал и получение списка фильмов с его участием, а также получение дополнительной информации из базы 💙 TMDB и даты выхода всех сезонов и серий:
