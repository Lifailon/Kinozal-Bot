...
# 01.01.2023 (0.4.3) - Добавлен функционал для управления Windows через WinAPI. Запуск и остановка приложений qBittorrent и Plex. 
...
# /win_api_get_dir <path> - Получить список директорий и файлов по указанному пути
# /win_api_del_dir <path> - Удалить директорию или файл по указанному пути
### Example commands:
# /search Рокки 2
# /search 1979 Рокки
...
function count-torrent {
    ...
    keyboard="{
        \"inline_keyboard\":[
            ...
            {\"text\":\"⚙️ Windows API\",\"callback_data\":\"\/win_state\"}]
        ]
    }"
...
# Обрезато имя и изменить select
# Получить описание текущей директории
